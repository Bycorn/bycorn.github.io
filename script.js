...
$.ajax({
  ...
  success: function (data) {
    ...
    videoFiles.sort(function (a, b) {
      return (
        new Date(fs.statSync("video/" + b).mtime) -
        new Date(fs.statSync("video/" + a).mtime)
      );
    });
  },
});
...
// Dodaj kod, który po zainicjowaniu obiektów i przetworzeniu listy filmów rozpocznie odtwarzanie pierwszego filmu
